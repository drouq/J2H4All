...
def system_prompt(db, today=None) -> str:
    return (
        ...
        "fluff. Cover today's planned session (what and why), how his recovery looks (Garmin Training "
        ...
        "his sleep score per the doctrine's sleep rule — high restlessness vs HIS baseline, not vs zero. "
        ...
        "morning's. Use `recent_lifestyle` (his end-of-day logs: alcohol, illness, poor/restless sleep, "
        ...
        "If `overnight_recovery_is_current` is false, the athlete hasn't synced his watch since last "
        ...
        "normally without harping on freshness. You do NOT know when his watch last uploaded to Garmin — NEVER "
