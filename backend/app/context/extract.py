...
def _system(today: date, current_tz: str) -> str:
    return (
        ...
        "durable facts about his body, life, or constraints into typed items. Only extract things "
        ...
        "- dietary_note: a fueling/diet note (he is vegetarian, fixed). Put the note in text.\n"
        "- preference: a structured constraint like long-run day or no-sessions-before time. Set key and text (the value).\n"
        "- timezone: he says where he is ('I'm in London this week'). Set timezone to the IANA zone.\n"
